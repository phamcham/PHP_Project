                        ...
                        <form action="/PHP_Project/Manager/Application/Update/<?php echo $data['application']['idApplication'] ?>" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group input-group mb-3">
                                            ...
                                            <input id="name" type="text" class="form-control" name="name" value="<?php echo $data['application']['name'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group input-group mb-3">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group input-group mb-3">
                                            ...
                                            <input id="birthday" type="date" class="form-control" name="birthday" value="<?php echo $data['application']['birthday'] ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group input-group mb-3">
                                            ...
                                            <input id="birthplace" type="text" class="form-control" name="birthplace" value="<?php echo $data['application']['birthplace'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group input-group mb-3">
                                            ...
                                            <span class="input-group-text icon-text"><i class="fas fa-bars"></i></span>
                                            <input id="ethnic" type="text" class="form-control" name="ethnic" value="<?php echo $data['application']['ethnic'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group input-group mb-3">
                                            ...
                                            <input id="phoneNumber" type="text" class="form-control" name="phoneNumber" value="<?php echo $data['application']['phoneNumber'] ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group input-group mb-3">
                                            ...
                                            <input id="identification" type="text" class="form-control" name="identification" value="<?php echo $data['application']['identification'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group input-group mb-3">
                                            ...
                                            <input id="expiration" type="date" class="form-control" name="expiration" value="<?php echo $data['application']['expiration'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group input-group mb-3">
                                            ...
                                            <input id="email" type="email" class="form-control" name="email" value="<?php echo $data['application']['email'] ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <div class="form-group input-group mb-3">
                                            ...
                                            <input id="address" type="text" class="form-control" name="address" value="<?php echo $data['application']['address'] ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container ">
                                <div class="justify-content-end d-flex">
                                    <input class="btn btn-danger btn-toolbar mr-3" type="submit" name="cancelUpdateApplication" value="Huỷ">
                                    <input class="btn btn-success btn-toolbar" type="submit" name="updateApplication" value="Lưu thay đổi">
                                </div>
                            </div>
                        </form>
                        <!-- content end -->
