...
CREATE TABLE IF NOT EXISTS `AdmissionsManagement`.`Application` (
  ...
  INDEX `fk_Application_ResultExam1_idx` (`idExamResult` ASC) VISIBLE,
  INDEX `fk_Application_AdmissionsMajor1_idx` (`idAdmissionsYear` ASC, `idMajors` ASC) VISIBLE,
